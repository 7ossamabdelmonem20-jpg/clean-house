                ...
                >
                  ...
                  <AnimatePresence>
                    {openIndex === i && (
                      ...
                      >
                        <div className="px-5 pb-5 pt-4 text-sm leading-relaxed text-gray-600 border-t border-gray-100">
                          {item.answer}
                        </div>
                      </motion.div>
                    )}
            ...
            >
              ...
              <div className="flex flex-wrap gap-3 justify-center">
                ...
                <a
                  ...
                  className="bg-white text-blue-800 font-bold py-2.5 px-6 rounded-full hover:bg-blue-50 transition-colors text-sm inline-flex items-center gap-2"
                >
                  📞 اتصل الآن
                </a>
              </div>
