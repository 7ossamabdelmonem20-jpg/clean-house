        ...
        <div className={`transition-all duration-500 ${isServicePage || scrolled ? 'py-2' : 'py-4'}`}>
          <nav className="container-custom" aria-label="القائمة الرئيسية">
            <div className="flex items-center justify-between">
              ...
              {/* Logo */}
              <Link href="/" className="flex items-center gap-2 sm:gap-3 group flex-shrink-0" aria-label="كلين هاوس">
                <div className="w-9 h-9 sm:w-10 sm:h-10 bg-gradient-to-br from-blue-600 to-blue-800 rounded-xl flex items-center justify-center shadow-lg group-hover:scale-105 transition-transform">
                  <span className="text-white text-base font-black">C</span>
                </div>
                <div>
                  <span className={`font-black text-lg sm:text-xl tracking-tight block ${isLight ? 'text-white' : 'text-blue-800'}`}>
                    كلين هاوس
                  </span>
                      ...
                      <>
                        <button
                          ...
                          className={`flex items-center gap-1 px-4 py-2 rounded-lg font-semibold text-sm transition-all duration-200 ${
                            isLight ? 'text-white/90 hover:text-white hover:bg-white/10' : 'text-gray-700 hover:text-blue-700 hover:bg-blue-50'
                          }`}
          ...
          <>
            ...
            >
              ...
              <div className="p-4 border-t border-gray-100 space-y-3 flex-shrink-0">
                ...
                <a href={SITE_CONFIG.tel} onClick={() => setIsOpen(false)}
